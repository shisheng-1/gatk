...
//    public Path parentDirectory = null;
    ...
    @Argument(fullName = "ref-block-gq-to-ignore",
            ...
            optional = true)
    public PetCreator.GQStateEnum gqStateToIgnore = PetCreator.GQStateEnum.SIXTY;
    ...
    public void onTraversalStart() {
        ...
        petTsvCreator = new PetCreator(sampleIdentifierForOutputFileName, sampleId, tableNumber, seqDictionary, gqStateToIgnore, dropAboveGqThreshold, outputDir, outputType, enablePet, writeReferenceRanges, projectID, datasetName);
